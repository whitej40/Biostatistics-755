...
ods rtf file="C:\Users\mclaina\OneDrive - University of South Carolina\Teaching\755_Spring_2022\Examples\02 - Covariance Matrices.rtf";
...
proc mixed data=long_lead;
class ID TRT week;
model PB = TRT week week*TRT/s;
repeated week/type=VC subject=ID r rcorr;
run; 

proc mixed data=long_lead;
class ID TRT week;
model PB = TRT week week*TRT/ s ;
repeated week/type=UN subject=ID r rcorr;
run;
...
class ID TRT week;
model PB = TRT week week*TRT/ s;
repeated week/type=CS subject=ID r rcorr;
run;
...
class ID TRT week;
model PB = TRT week week*TRT/ s;
repeated week/type=CSH subject=ID r rcorr;
run;
...
class ID TRT week;
model PB = TRT week week*TRT/ s ;
repeated week/type=TOEP(3) subject=ID r rcorr;
run;

proc mixed data=long_lead;
class ID TRT week;
model PB = TRT week week*TRT/ s ;
repeated week/type=AR(1) subject=ID r rcorr;
run;
...
class ID TRT week;
model PB = TRT week week*TRT/ s ;
repeated week/type=ARH(1) subject=ID r rcorr;
run;
...
class ID TRT week;
model PB = TRT week week*TRT/ s ;
repeated week/type=SP(EXP)(week) subject=ID r rcorr;
run;
...
class ID TRT week;
model PB = TRT week week*TRT/ s ;
repeated week/type=UN subject=ID r=1,2 rcorr=1,2 GROUP=TRT;
run;
